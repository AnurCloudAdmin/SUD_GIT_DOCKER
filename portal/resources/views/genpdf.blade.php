...
<head>
    ...
    //    $image_url = 'https://dev1.anurcloud.com/sudlife/portal/public/upload/' . $applicationNumber . '-' . $version . '/img/link_upload.jpeg';
    //    $imageExists = File::exists($image_url);
    //    $selfie_url = 'https://dev1.anurcloud.com/sudlife/portal/public/upload/' . $applicationNumber . '-' . $version . '/img/video_consent.jpeg';
    //    $images = 'https://dev1.anurcloud.com/sudlife/portal/public/upload/' . $applicationNumber . '-' . $version . '/img';
        }else{
...
<div class="keep-together">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <p><b>Completed On</b>: {{$data['completed_on']}}</p>
            </td>
        </tr>
        <br/><br/>
        <tr>
    ...
    <table width="100%">
        ...
        <tr>
            <td style="line-height: 2.5;">
                ...
                // if($data->sys_lang=='mar' )
                //   $fontChosse = 'font-family:marathi'; 
            ...
            if (strpos($data['speech_res'], "\r\n\r\n") !== false) {
                ...
                // It's plain JSON
                $body = $data['speech_res'];
            }

            $speechResponse = json_decode($body, true);
          
            // Check if the speech response is null or empty
    ...
    <tbody>
      <tr>
        ...
        <!-- <p><b>Video Link :</b> <a target="_blank" href="<?php echo $video_url?>" class="clrtxt">Click here</a></p> -->
      </td>
      </tr>
    </tbody>
    </table>
