    ...
    <div class="container-fluid" style="max-width: inherit;">
      ...
      <div class="page-title-box">
        ...
        <div class="row align-items-center">
          <div class="col-sm-6">
            <h4 class="page-title">Retrigger All Proposals</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-right">
              <li class="breadcrumb-item"><a href="{{url('home')}}">Home</a></li>
              <li class="breadcrumb-item active">Retrigger All Proposals</li>
            </ol>
          </div>
        </div>
        <!-- end row -->
                ...
                <div class="d-flex col-md-12">
                  <div class="form-group col-md-12">
                    ...
                    <button id="final-submit" type="submit" class="btn btn-primary col-md-2" style="float: right;">Submit</button> -->
                        ...
                        <form action="{{ route('excel.upload') }}" method="POST" enctype="multipart/form-data" class="form-control col-md-6" style="float: left">
                        @csrf
