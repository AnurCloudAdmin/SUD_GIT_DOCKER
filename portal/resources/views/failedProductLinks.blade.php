    ...
    <div class="container-fluid">
      ...
      <div class="page-title-box">
        <div class="row align-items-center">
          <div class="col-sm-6">  
            <h4 class="page-title">Failed Product Links</h4> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-right">
              <li class="breadcrumb-item"><a href="{{url('home')}}">Home</a></li>
              <li class="breadcrumb-item active">Failed Product Links</li>
            </ol>
          </div>
        </div>
        <!-- end row -->
      ...
      <div class="row">
        <div class="col-12">
          <div class="card m-b-30">
            ...
            <form method="post" id="reportsdownload" name="reportsdownload" action="{{env('APP_URL')}}failedproductlinksreportdownload" style="display: inline-block;" > 
            @csrf
